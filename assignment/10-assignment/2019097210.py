...
def main():
    ...
    arm1 = Node(arm, glm.translate(glm.vec3(.5,0,0)), glm.translate((.25,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    arm2 = Node(base, glm.translate(glm.vec3(-.2,0,0)), glm.translate((-.25,0,.03)) * glm.scale((-.25,.1,0.)), glm.vec3(1,0,0))
    arm3 = Node(arm2, glm.translate(glm.vec3(-.5,0,0)), glm.translate((-.25,0,.04)) * glm.scale((-.25,.1,0.)), glm.vec3(0,1,0))
