...
def key_callback(window, key, scancode, action, mods):
    ...
    global g_z1_deg, g_x_deg, g_z2_deg
...
def main():
    ...
    while not glfwWindowShouldClose(window):
        ...
        # ZYX Euler angles
        t = glfwGetTime()
        Rz1 = glm.rotate(np.radians(g_z1_deg), (0,0,1))
        Ry = glm.rotate(np.radians(g_x_deg), (1,0,0))
        Rz2 = glm.rotate(np.radians(g_z2_deg), (0,0,1))
